...
test_that("Basic SEM works", {
  ...
  expect_equal_tables(fittab, list(48.1563554263441, 59.7437959940257, 0, 0, "Model1", 75, 1, "",
                                   0, 0), "Model fit table")
...
test_that("Multigroup, multimodel SEM works", {
  ...
  expect_equal_tables(fittab, list(3189.26691715402, 3383.93591869107, 82.2032643259552, 70, "default",
                                   ...
                                   83.2843775176126, 73, "constrained", 75, 0.19249046571302, 0.647754490401082,
                                   1.65156784895982, 3, 3181.07183366569, 3361.83590652152, 86.0081808376312,
                                   76, "more constrained", 75, 0.202652084622712, 0.110596895607353,
                                   6.02091896557491, 3), "Model fit table")
